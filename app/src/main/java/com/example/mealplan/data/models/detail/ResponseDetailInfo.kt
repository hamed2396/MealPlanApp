...
data class ResponseDetailInfo(
    ...
    val spoonacularScore: Double?, // 83.37610626220703
    ...
    data class Nutrition(
        ...
        data class CaloricBreakdown(
            ...
            val percentCarbs: Double?, // 61.1
            @SerializedName("percentFat")
            val percentFat: Double?, // 26.61
            @SerializedName("percentProtein")
            val percentProtein: Double? // 12.29
        )
        ...
        data class Ingredient(
            ...
            data class Nutrient(
                ...
                val percentOfDailyNeeds: Double?, // 27.99
                @SerializedName("unit")
                val unit: String? // g
            )
        }
        ...
        data class Nutrient(
            @SerializedName("amount")
            val amount: Double?, // 543.36
            @SerializedName("name")
            val name: String?, // Calories
            @SerializedName("percentOfDailyNeeds")
            val percentOfDailyNeeds: Double?, // 27.17
            @SerializedName("unit")
